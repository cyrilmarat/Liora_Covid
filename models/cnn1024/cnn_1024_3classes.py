...
layer14=BatchNormalization(name="BatchNormalization5")

layer15 = MaxPooling2D(
    pool_size=(2, 2),
    name='max_pooling_layer5'
)
...
layer17=BatchNormalization(name="BatchNormalization6")

layer18 = MaxPooling2D(
    pool_size=(2, 2),
    name='max_pooling_layer6'
)

#layer 19 à 22
layer19 = GlobalAveragePooling2D()
layer20 = Dropout(rate=0.3)
...
model.save('cnn_1024_3classes.keras')
...
# Sauvegarde
plt.savefig('cnn_1024_3classes.png')
np.save('cnn_1024_3classes.npy',model_history.history)
