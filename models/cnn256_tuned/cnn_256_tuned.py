...
layer14 = Dropout(rate=dropout_1)
...
layer16 = Dropout(rate=dropout_2)
...
model.compile(loss='sparse_categorical_crossentropy', # fonction de perte
              optimizer=Adam(learning_rate=learning_rate),  # algorithme d'optimisation avec taux d'apprentissage ajusté
...
# Sauvegarde
plt.savefig('cnn_256.png')
np.save('cnn_256.npy',model_history.history)
