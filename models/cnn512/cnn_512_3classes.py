...
#layer 17 à 21
layer16 = GlobalAveragePooling2D()
...
model.save('cnn_512_3classes.keras')
...
# Sauvegarde
plt.savefig('cnn_512_3classes.png')
np.save('cnn_512_3classes.npy',model_history.history)
